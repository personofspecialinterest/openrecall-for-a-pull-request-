...
OpenRecall for Macs on Intel is a fully open-source, privacy-first alternative to proprietary solutions like Microsoft's Windows Recall or Limitless' Rewind.ai. With OpenRecall, you can easily access your digital history, enhancing your memory and productivity without compromising your privacy.
...
https://github.com/user-attachments/assets/63202640-dd46-44e2-92cc-e6039bc87b9f

## Why Choose OpenRecall **FMOI**?

OpenRecall for Macs on Intel offers several key advantages over other solutions:

- **Transparency**: OpenRecall FMOI is 100% open-source, allowing you to audit the source code for potential backdoors or privacy-invading features.
- **Web-Based**: OpenRecall for Macs on Intel works on a local network, letting you check it no matter which device of the network you are on.
...
- **Hardware Compatibility**: This designed to work with a [wide range of different Intel Macs](docs/hardware.md), unlike proprietary solutions that may require specific certified devices.
...
- **Time Travel**: Revisit and explore your past digital activities seamlessly across the network.
- **Local-First AI**: OpenRecall For Macs on Intel harnesses the power of local AI processing to keep your data private and secure.
...
| Feature          | OpenRecall for Macs on Intel  | Windows Recall                                  | Rewind.ai                              |
|------------------|-------------------------------|--------------------------------------------------|----------------------------------------|
| Transparency     | Open-source                   | Closed-source                                    | Closed-source                          |
| Supported Hardware | Intel Macs                  | Copilot+ certified Windows hardware              | M1/M2 Apple Silicon                    |
| OS Support       | macOS 10.13 (High Sierra)+    | Windows                                          | macOS                                  |
...
NOTICE!!: These links are from the original project from which this was forked. With that in mind, please remember that we are seperate projects! If you would like to check out the original, look for GitHub's "forked from" tag or you can view their website [here](datatalk.be). Thank you!
...
python3 -m pip install --upgrade --no-cache-dir git+https://github.com/personofspecialinterest/openrecall-for-macs-on-intel.git
```
...
1. Uninstall the package:
     ```
     python3 -m pip uninstall openrecall-for-macs-on-intel
     ```
...
confidentialclientreachout@gmail.com

## License

OpenRecall for Macs on Intel is released under the [AGPLv3](https://opensource.org/licenses/AGPL-3.0), ensuring that it remains open and accessible to everyone.
